...
# Stub line prefixes generated by adopt_governance.py template — not real content.
_STUB_LINE_PREFIXES: tuple[str, ...] = (
    "N/A \u2014 fill in or replace",  # em-dash variant (baseline template)
    "N/A - fill in or replace",       # hyphen variant (safety net)
)
        ...
        if m:
            ...
            while i < len(lines) and not lines[i].strip().startswith("##"):
                ...
                if stripped.startswith("<!--"):
                    ...
                    continue
                # Stub placeholder lines generated by adopt_governance.py — not real content
                if any(stripped.startswith(p) for p in _STUB_LINE_PREFIXES):
                    continue
